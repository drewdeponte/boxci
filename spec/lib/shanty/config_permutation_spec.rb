...
describe Shanty::ConfigPermutation do
  describe "#initialize" do
    it "constructs an instance of a Shanty::ConfigPermutation given an array of config permutation components" do
      config_permutation_components = [double, double, double]
      config_permutation = Shanty::ConfigPermutation.new(config_permutation_components)
    end
